...
import ProvinceCoverage from "./components/provinceCoverage.vue";
import CityCoverage from "./components/cityCoverage.vue";
import AqiDistribution from "./components/aqiDistribution.vue";
import Trend from "./components/trend.vue";
import Pm25 from "./components/pm25.vue";
import So2 from "./components/so2.vue";
